import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.a10e78c8.js";const m=JSON.parse('{"title":"progress-scroll 滚动进度可视化插件","description":"","frontmatter":{},"headers":[],"relativePath":"vue3-progress-scroll.md","filePath":"vue3-progress-scroll.md","lastUpdated":1696927626000}'),p={name:"vue3-progress-scroll.md"},t=l(`<h1 id="progress-scroll-滚动进度可视化插件" tabindex="-1">progress-scroll 滚动进度可视化插件 <a class="header-anchor" href="#progress-scroll-滚动进度可视化插件" aria-label="Permalink to &quot;progress-scroll 滚动进度可视化插件&quot;">​</a></h1><blockquote><p>🤖🎉🎉 进度监控可视化插件是一个基于 原生 <code>Css + Vue3 钩子</code> 封装的实用 hooks 工具，用于在 Vue.js 应用程序中展示进度。它提供了一种简单、高效的操作体验、深深感受开发的乐趣 ~</p></blockquote><h2 id="📦-体验" tabindex="-1">📦 体验 <a class="header-anchor" href="#📦-体验" aria-label="Permalink to &quot;📦 体验&quot;">​</a></h2><p><a href="https://huozaifenlangli.github.io/Vue3-template/#/scroll" target="_blank" rel="noreferrer">一键速看</a></p><h2 id="🌍-安装" tabindex="-1">🌍 安装 <a class="header-anchor" href="#🌍-安装" aria-label="Permalink to &quot;🌍 安装&quot;">​</a></h2><p>你可以使用 npm 或 pnpm 安装插件：</p><div class="language-javascript vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">npm i vue3</span><span style="color:#F97583;">-</span><span style="color:#E1E4E8;">progress</span><span style="color:#F97583;">-</span><span style="color:#E1E4E8;">scroll</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292E;">npm i vue3</span><span style="color:#D73A49;">-</span><span style="color:#24292E;">progress</span><span style="color:#D73A49;">-</span><span style="color:#24292E;">scroll</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><h2 id="🛹-注入" tabindex="-1">🛹 注入 <a class="header-anchor" href="#🛹-注入" aria-label="Permalink to &quot;🛹 注入&quot;">​</a></h2><p>在你的主应用程序入口文件（例如 main.js）中，导入并使用 ： <strong><em><code>main.js</code></em></strong></p><div class="language-javascript vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/* Step 1</span></span>
